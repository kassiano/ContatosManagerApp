...
class Contato{
    ...
    public static function all() {
        ...
        try {
            ...
            $req = $db->prepare('SELECT * FROM '.DBSCHEMA.'contatos where idUser=:id');
    ...
    public static function inserir($contato){
        ...
        try {
            ...
            $stmt = $db->prepare("INSERT INTO '.DBSCHEMA.'contatos (ID, nome, telefone, idUser) VALUES (:id ,:nome, :telefone, :userApp)");
    ...
    public static function find($id) {
        ...
        $id = intval($id);
        $req = $db->prepare('SELECT * FROM '.DBSCHEMA.'contatos WHERE ID = :id');
    ...
    public static function atualizar($contato)
    {
        ...
        try {
            ...
            $stmt = $db->prepare("UPDATE ".DBSCHEMA."contatos set nome= :nome, telefone=:telefone where ID = :id");
            $stmt->bindParam(':id', $contato->id , PDO::PARAM_STR );
            $stmt->bindParam(':nome', $contato->nome , PDO::PARAM_STR);
            $stmt->bindParam(':telefone', $contato->telefone, PDO::PARAM_STR);
    ...
    public static function deletar($id)
    {
        try {
            ...
            $stmt = $db->prepare("DELETE FROM ".DBSCHEMA."contatos WHERE ID=:id");
